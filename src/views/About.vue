    ...
    <div class="home">
      ...
      <div class="home_d">
        <div class="add">
          ...
          <input class="inp" type="text" placeholder="手机号码" />
          <input class="inp" type="text" placeholder="身份证号" />
        </div>
    ...
    <div class="main_nev">
      <div class="main_left">
        ...
        <div class="ma_btn">
          <div class="ma_top">
            <label>
              <input name="Fruit" type="radio" value />视频会议
            </label>
            <label>
              <input name="Fruit" type="radio" value />留言咨询
            </label>
          </div>
          <textarea
            style="width:95%;height:50%; padding: 0 0.5rem;border:none; font-size:.9rem"
            placeholder="简要秒速需要咨询的问题，方便医生了解"
          ></textarea>
        </div>
        <div class="footer">
          <p class="p1">注：1、问诊时长>6分钟（视患者情况适当调整）</p>
          <span>2、可以选择固定坐诊日期</span>
          <span>3、替患者整理资料</span>
        </div>
      </div>
      <div class="button">
...
.button {
  ...
  button {
    ...
    padding: 0.4rem;
    border: none;
    background: linear-gradient(to right, #51a5fc, #4dc1f4);
    // background: #51a5fc;
    color: #fff;
...
html {
  ...
  .home_x {
    ...
    .sp1 {
      ...
      height: 1rem;
      margin-top: 12px;
      background-image: linear-gradient(to right, #51a7fb, #4dc1f3);
      margin-left: 1.22rem;
      margin-right: 0.4rem;
    }
  }
